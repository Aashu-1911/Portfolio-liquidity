  ...
  if (dataLoading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4 bg-background">
        ...
        <p className="text-muted-foreground text-sm">Loading S&P 500 dataset & computing features...</p>
      </div>
    );
  }
              ...
              {!result && !loading && (
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground max-w-sm">
                    Build your portfolio on the left and click "Analyze Liquidity" to get ML-powered insights.
                  </p>
                </motion.div>
              )}
